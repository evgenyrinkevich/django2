# Generated by Django 3.2.8 on 2021-12-31 08:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('F', 'формируется'), ('S', 'отправлен в обработку'), ('D', 'оплачен'), ('P', 'обрабатывается'), ('R', 'готов'), ('C', 'отменен')], default='F', max_length=1, verbose_name='статус')),
